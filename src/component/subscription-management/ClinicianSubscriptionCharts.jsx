...
const ClinicianSubscriptionCharts = () => {
  ...
  const chartOptions = {
    ...
    yaxis: {
      title: {
        text: 'Number of Clinician Subscriptions',
      },
    },
    fill: {
      opacity: 1,
  ...
  const chartSeries = [
    {
      name: 'Active',
      data: Object.values(subscriptionData).map(data => data.clinicianSubscription.active),
    },
    {
      name: 'Renewal',
      data: Object.values(subscriptionData).map(data => data.clinicianSubscription.renewal),
    },
    {
      name: 'Ended',
      data: Object.values(subscriptionData).map(data => data.clinicianSubscription.ended),
    },
  ];
    ...
    <Card className="mb-4">
      <Card.Header style={cardHeaderStyle} className="bg-primary text-white d-flex justify-content-between align-items-center">
        <Typography variant="h6" component="h4" style={{ color: 'white', fontWeight: 'bold' }}>
          Clinician Subscription Overview
        </Typography>
        {isAdminPortal && (
