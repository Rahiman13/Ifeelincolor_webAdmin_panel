        ...
        <Container maxWidth="lg">
          ...
          <HeadingContainer>
            ...
            <Typography variant="body1" align="center"
              ...
              Choose your role to access the admin features
            </Typography>
          </HeadingContainer>
            ...
            <Grid item xs={12} md={6} lg={5}>
              <ModernCard>
                <CardContent sx={{
                  ...
                  >
                    Manage all aspects of the platform, including user roles and system settings.
                  </Typography>
                  <StyledButton
                    variant="contained"
                    fullWidth
            ...
            <Grid item xs={12} md={6} lg={5}>
              <ModernCard>
                <CardContent sx={{
                  ...
                  >
                    Access tools to support administrators and help manage the platform.
                  </Typography>
                  <StyledButton
                    variant="contained"
                    fullWidth
                    onClick={() => handleNavigation('/assistant-login')}
                  >
                    Assistant Dashboard
                  </StyledButton>
                </CardContent>
...
export default Landing_AdminPortal;
