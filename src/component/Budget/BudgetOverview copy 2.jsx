...
import { mdiCurrencyUsd, mdiChartLine, mdiCashMultiple, mdiEye, mdiMonitor, mdiDoctor, mdiOfficeBuilding, mdiDownload, mdiAlertCircleOutline } from '@mdi/js';
                            ...
                            textField: {
                              ...
                              sx: {
                                ...
                                '& .MuiInputLabel-root': {
                                  color: '#fff',
                                  fontWeight: 600,
                                  fontSize: '0.75rem', // Make label size small
                                }
                              }
                            },
                            inputAdornment: {
