                      ...
                      <List>
                        <ListItem>
                          ...
                          <ListItemText
                            ...
                            secondary={
                              organizationData.socialProfile?.instagram ? (
                                <Link
                                href={organizationData.socialProfile.instagram}
                                target="_blank"
                        ...
                        <ListItem>
                          ...
                          <ListItemText
                            primary="Twitter"
                            secondary={
                              organizationData.socialProfile?.twitter ? (
                                <Link
                                href={organizationData.socialProfile.twitter}
                                target="_blank"
                                rel="noopener noreference "
                                style={{ color: theme.palette.primary.main }}
                                >
                        ...
                        <ListItem>
                          ...
                          <ListItemText
                            primary="Facebook"
                            secondary={
                              organizationData.socialProfile?.facebook ? (
                                <Link
                                  href={organizationData.socialProfile.facebook}
                                  target="_blank"
                        ...
                        <ListItem>
                          ...
                          <ListItemText
                            ...
                            secondary={
                              organizationData.socialProfile?.linkedin ? (
                                <Link
                                href={organizationData.socialProfile.linkedin}
                                target="_blank"
                                rel="noopener noreference "
                                style={{ color: theme.palette.primary.main }}
                                >
