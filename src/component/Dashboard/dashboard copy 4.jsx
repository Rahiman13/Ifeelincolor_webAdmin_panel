...
// Add the MetricCard component at the top of your file (after imports)
...
class Dashboard extends Component {
        ...
        this.setState(prevState => ({
            clinicianStatusData: {
                ...
                options: {
                    ...
                    colors: noData ? ['#E0E0E0'] : ["#4EE6C9", "#DC526C"],
                    dataLabels: {
                        enabled: true,
    ...
    calculatePercentageChange = (current, previous) => {
        ...
        // If both values are 0, return no change
        if (currentValue === 0 && previousValue === 0) {
            return 'No change';
        }

        // If previous value was 0, handle special case
        if (previousValue === 0) {
            return currentValue > 0 ? `↑ ${currentValue}` : 'No change';
        }
        ...
        // Return formatted string with arrow indicating direction
    ...
    handlePatientCardClick = () => {
        this.props.navigate('/patient-management/view');
    }
                        ...
                        <div className="row">
                            <div className="col-12 col-sm-6 col-lg-3 stretch-card grid-margin">
                                <MetricCard
                                    ...
                                    percentage={this.calculatePercentageChange(
                                        ...
                                        previousPeriodData.patientCount
                                    )}
                            ...
                            <div className="col-12 col-sm-6 col-lg-3 stretch-card grid-margin">
                                <MetricCard
                                    ...
                                    percentage={this.calculatePercentageChange(
                                        counts.totalDoctors,
                                        previousPeriodData.clinicianCount
                                    )}
                            ...
                            <div className="col-12 col-sm-6 col-lg-3 stretch-card grid-margin">
                                <MetricCard
                                    ...
                                    percentage={this.calculatePercentageChange(
                                        ...
                                        previousPeriodData.subscriptionCount
                                    )}
                            ...
                            <div className="col-12 col-sm-6 col-lg-3 stretch-card grid-margin">
                                <MetricCard
                                    ...
                                    percentage={this.calculatePercentageChange(
                                        counts.totalEarnings,
                                        previousPeriodData.earnings
                                    )}
