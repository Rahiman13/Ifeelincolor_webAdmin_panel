  ...
  return (
    <div className="d-flex vh-100">
      ...
      <div className="col-lg-7 p-0 d-none d-lg-block">
        ...
        >
          <h1 className="display-4 text-white mb-4" style={{ fontWeight: 300 }}>Welcome to IFEELINCOLOR Admin Portal</h1>
          ...
          <p className="lead text-white-50" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}></p>
        </div>
      </div>
      ...
      <div className="col-lg-5 d-flex align-items-center justify-content-center bg-white">
        <div className="w-75">
          <div className="text-center mb-5">
            ...
            <h2 style={{ fontWeight: 300, color: '#333', letterSpacing: '1px' }}>IFEELINCOLOR Admin Sign In</h2>
            <p className="text-muted" style={{ fontSize: '0.9rem' }}>Access your IFEELINCOLOR Admin dashboard</p>
          </div>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-end align-items-center mb-4">
              <Link to='/forget' style={{ fontSize: '0.9rem', color: '#007bff', textDecoration: 'none', fontWeight: 500 }}>Forgot password?</Link>
            </div>
            <Button
              type="submit"
