            ...
            <div className="auth-form-light text-left py-4 px-4 px-sm-5 bg-white rounded-md shadow">
              ...
              <Form onSubmit={handleSubmit} className="pt-3">
                ...
                <div className="my-2 d-flex justify-content-end align-items-center">
                  <Link to='/organization-forget' className="auth-link underline">Forgot password?</Link>
                </div>
              ...
              <ToastContainer />
              <div className="">
                <p className="text-center mt-3">Don't have an account? <Link to='/organization-register'>Create</Link></p>
              </div>
            </div>
          </div>
        </div>
