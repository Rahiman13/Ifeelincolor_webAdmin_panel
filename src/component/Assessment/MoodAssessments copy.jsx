...
export default function MoodAssessments() {
  ...
  const handleMoodAssessmentModalOpen = async (mode, assessmentId) => {
    ...
    if (mode === 'edit' && assessmentId) {
      try {
        const assessment = await fetchMoodAssessmentDetails(assessmentId);
        ...
        console.log('Setting openMoodAssessmentModal to true');
        setOpenMoodAssessmentModal(true);
      } catch (error) {
        console.error('Error fetching assessment details:', error);
      }
    } else {
      console.log('Setting openMoodAssessmentModal to true (non-edit mode)');
      setOpenMoodAssessmentModal(true);
    }
    handleMenuClose();
  };
