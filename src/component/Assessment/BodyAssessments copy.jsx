...
import { Add, MoreVert, Visibility, Edit, Delete, ExpandMore, ExpandLess, CloudUpload, Close as CloseIcon } from '@mui/icons-material';
...
const BodyAssessments = () => {
  ...
  const renderEditBodyAssessmentModal = () => {
    // Define modal mode based on state
    const isEdit = editBodyAssessmentModal && selectedBodyAssessment;
    const modalMode = isEdit ? 'edit' : 'add';
      ...
      >
        <StyledDialogTitle>
          ...
          <span className="title-text">
            {modalMode === 'edit' ? 'Edit Body Assessment' : 'Add New Body Assessment'}
          </span>
        </StyledDialogTitle>
        ...
        <StyledDialogContent>
          ...
          <div className="form-section">
            ...
            >
              ...
              />
              {newBodyAssessment.media ? (
                <Box sx={{ position: 'relative' }}>
                  <img src={newBodyAssessment.media} alt="Preview" />
                  <IconButton
                    size="small"
                ...
                <Box sx={{ textAlign: 'center' }}>
                  <Icon path={mdiCloudUpload} size={2} color="#64748b" />
        ...
        <StyledDialogActions>
          ...
          <Button
            variant="contained"
            onClick={modalMode === 'edit' ? handleEditBodyAssessment : handleCreateBodyAssessment}
          ...
          >
            {actionLoading ? 'Saving...' : (modalMode === 'edit' ? 'Save Changes' : 'Create Assessment')}
          </Button>
        </StyledDialogActions>
      </StyledDialog>
    );
