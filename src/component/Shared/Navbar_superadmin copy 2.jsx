        ...
        <ul className="navbar-nav navbar-nav-right d-flex align-items-center">
          <li className="nav-item">
            <Dropdown>
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list" style={notificationDropdownStyle}>
                <h6 style={notificationHeaderStyle}>Notifications</h6>
                {(showAllNotifications ? notifications : notifications.slice(0, 5)).map(notification => (
                  <Dropdown.Item key={notification._id} className="dropdown-item preview-item" style={notificationItemStyle}>
                    <div className="d-flex align-items-start">
                      <div className="notification-icon me-3">
                        <div style={{
                          ...
                          <i className="mdi mdi-bell-outline" style={{ color: '#3498db', fontSize: '16px' }}></i>
                        </div>
                      </div>
                      <div className="flex-grow-1">
                        <p className="mb-1" style={{ fontSize: '0.95rem', fontWeight: '500', lineHeight: '1.4' }}>
                ...
                <div style={notificationFooterStyle} onClick={() => setShowAllNotifications(!showAllNotifications)}>
