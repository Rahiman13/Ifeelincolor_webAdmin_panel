...
class Navbar extends Component {
  ...
  handlePowerClick() {
    this.props.history.push('/lockscreen');
  };
  render() {
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <Link className="navbar-brand brand-logo-mini" to="/"><img src={Logo_mini} alt="logo" /></Link>
        </div>
        <div className="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            ...
            {/* <li className="nav-item">
              <Dropdown alignRight>
                ...
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  <h6 className="p-3 mb-0">Patient Messages</h6>
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                    ...
                    <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                      <h6 className="preview-subject ellipsis mb-1 font-weight-normal">Dr. Smith sent a message</h6>
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                    ...
                    <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                      <h6 className="preview-subject ellipsis mb-1 font-weight-normal">New appointment request</h6>
                      <p className="text-gray mb-0">
                        10 Minutes ago
                      </p>
                    </div>
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                    ...
                    <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                      <h6 className="preview-subject ellipsis mb-1 font-weight-normal">Medication reminder set</h6>
                      <p className="text-gray mb-0">
                        30 Minutes ago
                      </p>
                    </div>
                  ...
                  <div className="dropdown-divider"></div>
                  <h6 className="p-3 mb-0 text-center cursor-pointer">3 new messages</h6>
                </Dropdown.Menu>
              </Dropdown>
            </li> */}
            <li className="nav-item">
            ...
            <li className="nav-item nav-logout d-none d-lg-block">
              {/* <a className="nav-link" href="/user-pages/login-1" onClick={event => event.preventDefault()}>
